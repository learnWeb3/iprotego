    ...
    <#elseif section = "form">
        <form id="kc-passwd-update-form" action="${url.loginAction}" method="post" class="w-full lg:w-2/3 flex flex-col gap-8 mt-8">
          ...
          <div class="flex flex-col gap-6">
            ...
            <input class="h-12 bg-gray-800 hover:bg-black transition duration-150 ease-in-out rounded-full w-full text-white text-center" type="submit" value="Update password" />
          </div>
        </form>
    </#if>
