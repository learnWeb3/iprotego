    ...
    <#elseif section = "form">
        <form id="kc-reset-password-form" action="${url.loginAction}" method="post" class="w-full lg:w-2/3 flex flex-col gap-8 mt-8">
            ...
            <div class="flex flex-col gap-6">
                ...
                <input class="cursor-pointer h-12 bg-gray-900 hover:bg-black transition duration-150 ease-in-out rounded-full w-full text-white text-center" type="submit" value="Reset password" />
